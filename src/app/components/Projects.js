...
const TensorFlowCertPhotos = [
  {
    src: "/assets/images/loaders/DevCert.png",
    width: 1080,
    height: 720,
    alt: "Photo by Diego Guzmán",
  },
  ...
  return (
    <div id="Projects">
      ...
      >
        ...
        <div className="row">
          <div className="col-md-6 photosSide">
        ...
        <div className="row">
          <div className="col-md-6">
            <div className="card-body">
              <h1 className="card-title">
                <div className="project__header">
                  <span className="projectHighlight">A.I. Assortment</span>
              ...
              <ul className="pHighlightList">
                ...
                <li>
                  <MdKeyboardDoubleArrowRight />
                  Developed a multivariate time series forecasting model using
                  TensorFlow to predict future S&P 500 prices, integrating
                  economic indicators like interest rates, unemployment, CPI,
                  and the VIX for enhanced financial analysis.
                </li>
                <li>
                  <MdKeyboardDoubleArrowRight />
                  Built and optimized a spam detection model for use in this
                  Portfolio using the Universal Sentence Encoder, achieving 98%
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col">
                    <div className="icons d-flex mb-3 justify-content-between flex-grow-1">
                      {["PYTHON", "TENSORFLOW", "COLAB"].map((title, index) => (
                        <a
                          key={index}
                          href="#"
                          title={title}
          ...
          <div className="col-md-6 photosSide">
            <Carousel controls={false} indicators={false} interval={3000}>
              {TensorFlowCertPhotos.map((photo, index) => (
                <Carousel.Item key={index}>
                  <div className="carousel-image-wrapper">
                    <img src={photo.src} alt={photo.alt} />
                  </div>
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="card-body">
              <h1 className="card-title">
                <div className="project__header">
                  <span className="projectHighlight"><MdKeyboardDoubleArrowLeft /></span>
              ...
              <ul className="pHighlightList">
                <li>
                  <MdKeyboardDoubleArrowRight />
                  Designed a custom deep learning neural style transfer model using VGG19
                  so that I could blend content and style images through computer vision.
                </li>
                <li>
                  <MdKeyboardDoubleArrowRight />
                  Developed an optimized training loop with TensorFlow's
                  GradientTape, focusing on backpropagation and
                  regularization.
                </li>
                <li>
                  <MdKeyboardDoubleArrowRight />
